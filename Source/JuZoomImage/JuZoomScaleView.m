...
//    isFinishLoad=NO;
    ...
    if (_ju_imageM.ju_imageType==JuImageTypeImage) {
        ...
        if ([UIImageView diskImageDataExistsWithKey:_ju_imageM.ju_thumbImageUrl]) {
            UIImage *lastPreviousCachedImage = [UIImageView imageFromDiskCacheForKey:_ju_imageM.ju_thumbImageUrl];
...
-(void)juGetNetImage:(NSString *)imageUrl{
    ...
    [ju_imgView juSetImageWithURL:imageUrl  progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
