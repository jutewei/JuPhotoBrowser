...
-(void)juSetRightButton{
    ...
    [btnBack setImage:[UIImage imageNamed:juPhotoBundle(@"photo_un_select")] forState:UIControlStateNormal];
    [btnBack setImage:[UIImage imageNamed:juPhotoBundle(@"photo_select")] forState:UIControlStateSelected];
